...
/**
 * Endpoint for getting a single collection.
 */
public class GetCollection extends Endpoint<ModrinthCollection, EmptyRequest> {
     ...
     */
    public GetCollection(HttpClient client, Gson gson) {
        super(client, gson);
    }
